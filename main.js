...
var Service2Service = /** @class */ (function () {
    function Service2Service(http) {
        ...
        //https://apigatewaysiiii.azurewebsites.net/api/v3/appointments
        this.Url = 'https://apigatewaysiiii.azurewebsites.net/api/v3/appointments';
    }
...
var Service3Service = /** @class */ (function () {
    function Service3Service(http) {
        this.http = http;
        this.Url = 'https://pacientessaludab.azurewebsites.net/api/v1/patients';
    }
